...
def translate(text: str, *, src: str = 'auto') -> TranslateResult:
    ...
    target_language = LANGUAGES.get('en', 'Unknown')

    res = requests.get('https://clients5.google.com/translate_a/single', params=query, headers=headers)
    if res.status_code != 200:
        text = res.text
        raise TranslateError(res.status_code, text)
